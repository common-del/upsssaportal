...
export default async function SchoolTicketDetailPage(props: {
  ...
  if (!ticket || ticket.schoolUdise !== session.user.name) notFound();
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-8">
      <BackButton fallbackHref="/app/school/tickets" label={t('backToList')} className="mb-6 inline-flex items-center gap-1.5 text-sm text-navy-700 hover:text-navy-900" />
      ...
      <TicketActionBar ticketId={ticket.id} ticketStatus={ticket.status} role="SCHOOL" />
    </div>
  );
}
