...
const SCHOOLS_RAW: SchoolRecord[] = [
  ...
  { id: '4', name: 'Government Primary School, Paharia', udise: '09123456792', district: 'Varanasi', block: 'Paharia', type: 'Government', level: 'Primary', feeDisclosed: false, accreditation: 'Pending', overallScore: 38, domainScores: { 'Teaching and Learning': 40, 'Assessment and Learning Outcomes': 35, 'Administration, HR and Leadership': 42, 'Inclusiveness and Community Engagement': 36, 'Infrastructure and Safety': 37 }, students: 180, teachers: 8, performanceLevel: 'Uday' },
  { id: '5', name: 'Kanpur Public School', udise: '09123456793', district: 'Kanpur', block: 'Civil Lines', type: 'Private', level: 'Higher Secondary', feeDisclosed: true, accreditation: 'SQAAF Verified', overallScore: 71, domainScores: { 'Teaching and Learning': 70, 'Assessment and Learning Outcomes': 73, 'Administration, HR and Leadership': 69, 'Inclusiveness and Community Engagement': 72, 'Infrastructure and Safety': 71 }, students: 1560, teachers: 62, performanceLevel: 'Utkarsh' },
  { id: '6', name: 'Government Primary School, Naini', udise: '09123456794', district: 'Prayagraj', block: 'Naini', type: 'Government', level: 'Primary', feeDisclosed: true, accreditation: 'SQAAF Verified', overallScore: 58, domainScores: { 'Teaching and Learning': 60, 'Assessment and Learning Outcomes': 55, 'Administration, HR and Leadership': 62, 'Inclusiveness and Community Engagement': 57, 'Infrastructure and Safety': 56 }, students: 210, teachers: 6, performanceLevel: 'Unnat' },
  { id: '7', name: 'Saraswati Vidya Mandir', udise: '09123456795', district: 'Meerut', block: 'Sardhana', type: 'Aided', level: 'Secondary', feeDisclosed: true, accreditation: 'Pending', overallScore: 61, domainScores: { 'Teaching and Learning': 63, 'Assessment and Learning Outcomes': 59, 'Administration, HR and Leadership': 65, 'Inclusiveness and Community Engagement': 60, 'Infrastructure and Safety': 58 }, students: 680, teachers: 28, performanceLevel: 'Unnat' },
  { id: '8', name: 'Gorakhpur Model School', udise: '09123456796', district: 'Gorakhpur', block: 'Golghar', type: 'Government', level: 'Secondary', feeDisclosed: true, accreditation: 'SQAAF Verified', overallScore: 55, domainScores: { 'Teaching and Learning': 52, 'Assessment and Learning Outcomes': 56, 'Administration, HR and Leadership': 58, 'Inclusiveness and Community Engagement': 54, 'Infrastructure and Safety': 55 }, students: 920, teachers: 35, performanceLevel: 'Unnat' },
  { id: '9', name: 'Aligarh Muslim University High School', udise: '09123456797', district: 'Aligarh', block: 'AMU', type: 'Aided', level: 'Higher Secondary', feeDisclosed: true, accreditation: 'SQAAF Verified', overallScore: 79, domainScores: { 'Teaching and Learning': 82, 'Assessment and Learning Outcomes': 77, 'Administration, HR and Leadership': 81, 'Inclusiveness and Community Engagement': 78, 'Infrastructure and Safety': 77 }, students: 1100, teachers: 55, performanceLevel: 'Utkarsh' },
  { id: '10', name: 'Bareilly Central Academy', udise: '09123456798', district: 'Bareilly', block: 'Civil Lines', type: 'Private', level: 'Upper Primary', feeDisclosed: false, accreditation: 'Pending', overallScore: 48, domainScores: { 'Teaching and Learning': 46, 'Assessment and Learning Outcomes': 50, 'Administration, HR and Leadership': 47, 'Inclusiveness and Community Engagement': 49, 'Infrastructure and Safety': 48 }, students: 340, teachers: 14, performanceLevel: 'Uday' },
  { id: '11', name: 'Mathura Vidyalaya', udise: '09123456799', district: 'Mathura', block: 'Krishna Nagar', type: 'Private', level: 'Primary', feeDisclosed: true, accreditation: 'SQAAF Verified', overallScore: 64, domainScores: { 'Teaching and Learning': 66, 'Assessment and Learning Outcomes': 62, 'Administration, HR and Leadership': 67, 'Inclusiveness and Community Engagement': 63, 'Infrastructure and Safety': 62 }, students: 280, teachers: 12, performanceLevel: 'Utkarsh' },
  { id: '12', name: 'Government Girls Inter College, Agra', udise: '09123456800', district: 'Agra', block: 'Tajganj', type: 'Government', level: 'Higher Secondary', feeDisclosed: true, accreditation: 'SQAAF Verified', overallScore: 66, domainScores: { 'Teaching and Learning': 68, 'Assessment and Learning Outcomes': 64, 'Administration, HR and Leadership': 70, 'Inclusiveness and Community Engagement': 65, 'Infrastructure and Safety': 63 }, students: 980, teachers: 40, performanceLevel: 'Utkarsh' },
  { id: '13', name: 'Aided Upper Primary School, Assi', udise: '09123456801', district: 'Varanasi', block: 'Assi', type: 'Aided', level: 'Upper Primary', feeDisclosed: false, accreditation: 'Pending', overallScore: 42, domainScores: { 'Teaching and Learning': 44, 'Assessment and Learning Outcomes': 40, 'Administration, HR and Leadership': 43, 'Inclusiveness and Community Engagement': 41, 'Infrastructure and Safety': 42 }, students: 150, teachers: 7, performanceLevel: 'Uday' },
...
export const DOMAIN_AVERAGES = [
  ...
  { domain: 'Administration, HR and Leadership', score: 61 },
  { domain: 'Teaching and Learning', score: 58 },
  { domain: 'Assessment and Learning Outcomes', score: 54 },
  { domain: 'Inclusiveness and Community Engagement', score: 56 },
];
...
export const ALL_DISTRICTS = [...new Set(MANDALS.flatMap((m) => m.districts))].sort();
